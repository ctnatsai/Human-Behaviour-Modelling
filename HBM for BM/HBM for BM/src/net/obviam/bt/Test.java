...
import net.obviam.bt.Threat_Vector_AI.DeployAttackVector;
...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        Routine goal_work = Routines.repeatInfinite(
                Routines.sequence(
                        Routines.sequence(Routines.sensor()),
                        Routines.sequence(Routines.drinkCoffee(world)),
                        Routines.sequence(Routines.work(world))
                )
        );
